...
* @jbaruch расскажи про новый менеджер пакетов С в артифкатори пока что
* @jbaruch расскажи про Helm и зачем вы взяли себе экс-гуглера на работу
* Что такое JFrog XRay? https://www.jfrog.com/xray/
* Baruch говорит в темки, чувак не знает чем подход с ./gradlew лучше чем качать грейд ставить и юзать. Мне кажется это просто троллинг и не нужно об этом вещать долго и упорно..
